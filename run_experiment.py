...
def main(_run):
    ...
    print('Tensorboard url: ', 'http://eleutherai.bmk.sh:'+ tensorboard_port)
    os.system("screen -S tensorboard_{} -d -m 'tensorboard --logdir {} --port {} --bind_all --reload_multifile=true || tensorboard --logdir {} --port {} --reload_multifile=true'".format(_run._id, params["model_path"], tensorboard_port,params["model_path"], tensorboard_port,))
