...
def main(_run):
    ...
    os.system("screen -S tensorboard_{} -d -m 'tensorboard --logdir {} --port {} --bind_all --reload_multifile=true || tensorboard --logdir {} --port {}'".format(_run._id, params["model_path"], tensorboard_port,params["model_path"], tensorboard_port,))
