...
flags.DEFINE_multi_string('lang', default='en', help='language to include. can be specified multiple time for multi language')
flags.DEFINE_float('threshold', default=0.99, help='language to include. can be specified multiple time for multi language')
...
def main(_):
    while True:
        ...
        score = scores[0]
        if lang in FLAGS.lang and score > FLAGS.threshold:
